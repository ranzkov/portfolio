...
export default function Home() {
  const [selectedProject, setSelectedProject] = useState(null);
   ...
   const experiences = [
    ...
    return (
        <main className="min-h-screen bg-[#ffd1cd] font-mono text-[#192841] selection:bg-[#192841] selection:text-[#ffd1cd]">
        ...
        <div className="border-b border-[#192841]/20 bg-[#192841]/5 px-4 py-2 text-xs">
            ...
            <div className="flex items-center gap-3">
                ...
                <span>sys.status: <strong className="font-semibold">ONLINE</strong></span>
        ...
        {/* NAVBAR */}
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 border-b border-[#192841]/20">
            ...
            <div className="hidden gap-6 text-xs font-semibold md:flex">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 md:py-28">
            ...
            <div>
                <div className="inline-block border border-[#192841] bg-[#192841]/5 px-3 py-1 text-xs font-semibold mb-6">
                ...
                <p className="mt-4 text-sm font-bold tracking-wide uppercase opacity-70">
                ...
                Focusing on full-stack web engineering primarily with <span className="bg-[#192841] text-[#ffd1cd] px-1 font-semibold">Laravel</span> and modern front-end / mobile stacks (<span className="font-semibold">Next.js, Tailwind CSS, Flutter</span>). Experienced in building administrative platforms, business workflows, and API integrations with basic Docker orchestration.
                </p>

                <div className="mt-8 flex flex-wrap gap-4 text-xs font-bold">
                <a
                    href="#projects"
                    className="bg-[#192841] px-6 py-3.5 text-[#ffd1cd] transition hover:opacity-90 flex items-center gap-2"
                >
                ...
                <a
                    href="#contact"
                    className="border-2 border-[#192841] px-6 py-3.5 transition hover:bg-[#192841] hover:text-[#ffd1cd]"
                >
                    ./contact_me
                </a>
                </div>
            ...
            <div className="border-2 border-[#192841] bg-[#ffd1cd] p-4 shadow-[6px_6px_0px_0px_rgba(25,40,65,1)]">
                <div className="flex items-center justify-between border-b border-[#192841] pb-3 mb-4 text-xs">
                <div className="flex gap-1.5">
                    <span className="h-3 w-3 rounded-full border border-[#192841] bg-[#192841]/20" />
                    <span className="h-3 w-3 rounded-full border border-[#192841] bg-[#192841]/20" />
                    <span className="h-3 w-3 rounded-full border border-[#192841] bg-[#192841]/20" />
                </div>
                <span className="text-[11px] font-semibold opacity-70">profile_summary.ts</span>
                </div>

                <pre className="text-xs leading-relaxed overflow-x-auto text-[#192841]">
                <code>
                {`const developer = {
        ...
        {/* SECTION 1: EDUCATION */}
        <section id="education" className="border-t-2 border-[#192841] px-6 py-20">
            <div className="mx-auto max-w-7xl">
            <p className="text-xs font-bold tracking-widest uppercase mb-2 opacity-70">
                01 // ACADEMIC BACKGROUND
            </p>
            <h2 className="text-3xl font-bold mb-10">Education & Credentials</h2>

            <div className="space-y-6">
                {education.map((edu, idx) => (
                <div
                    key={idx}
                    className="border-2 border-[#192841] bg-[#ffd1cd] p-6 shadow-[4px_4px_0px_0px_rgba(25,40,65,1)] flex flex-col md:flex-row items-start md:items-center gap-6"
                >
                    {/* LOGO PLACEHOLDER */}
                    <div className="flex h-20 w-20 shrink-0 items-center justify-center border-2 border-[#192841] bg-[#192841]/10">
                        <img
                            src={edu.logo}
                            alt={edu.institution}
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-1">
                        ...
                        <span className="text-xs font-semibold bg-[#192841] text-[#ffd1cd] px-2 py-0.5 w-fit">
                        {edu.period}
                        </span>
                    </div>
                    ...
                    <p className="text-xs leading-relaxed mt-3 opacity-90">
                        {edu.details}
                    </p>
                    </div>
                </div>
        ...
        <section id="experience" className="border-t-2 border-[#192841] px-6 py-20">
            <div className="mx-auto max-w-7xl">
                <p className="text-xs font-bold tracking-widest uppercase mb-2 opacity-70">
                ...
                {experiences.map((exp, idx) => (
                    <div
                    key={idx}
                    className="border-2 border-[#192841] bg-[#ffd1cd] p-6 shadow-[4px_4px_0px_0px_rgba(25,40,65,1)] flex flex-col md:flex-row items-start gap-6"
                    >
                    {/* LOGO BOX */}
                    <div className="flex h-20 w-20 shrink-0 items-center justify-center border-2 border-[#192841] p-2">
                        <img 
                        src={exp.logo} 
                        alt={exp.company} 
                    ...
                    <div className="flex-1">
                        ...
                        <span className="text-xs font-semibold border border-[#192841] px-2 py-0.5 w-fit">
                            {exp.period}
                        </span>
                        </div>
        ...
        {/* TECH STACK GRID */}
        <section id="stack" className="border-t-2 border-[#192841] px-6 py-20">
            <div className="mx-auto max-w-7xl">
            <p className="text-xs font-bold tracking-widest uppercase mb-2 opacity-70">
                03 // TECHNICAL SPECIFICATIONS
            </p>
            <h2 className="text-2xl font-bold mb-10">System Architecture & Capabilities</h2>
            ...
            <div className="grid gap-6 md:grid-cols-4">
                ...
                <div key={idx} className="border border-[#192841] p-5 bg-[#192841]/5">
                    <span className="text-[10px] font-bold border border-[#192841] px-1.5 py-0.5">
                    SYS.0{idx + 1}
                    </span>
                    <h3 className="text-sm font-bold mt-4 mb-2">{item.category}</h3>
        ...
        {/* CONTACT SECTION */}
        <section id="contact" className="border-t-2 border-[#192841] px-6 py-24 text-center">
            <div className="mx-auto max-w-3xl">
            <p className="text-xs font-bold tracking-widest uppercase mb-3 opacity-70">
                05 // INITIALIZE CONNECTION
            </p>
            <h2 className="text-3xl font-extrabold md:text-5xl">
                Ready to collaborate?
            </h2>
            <p className="text-xs md:text-sm mt-4 opacity-80 max-w-lg mx-auto">
            ...
            <div className="mt-8">
                ...
                className="inline-block border-2 border-[#192841] bg-[#192841] px-8 py-4 text-xs font-bold text-[#ffd1cd] shadow-[4px_4px_0px_0px_rgba(255,209,205,1)] transition hover:translate-x-1 hover:translate-y-1"
                >
        ...
        {/* FOOTER */}
        <footer className="border-t border-[#192841]/20 px-6 py-6 text-[11px] opacity-70">
